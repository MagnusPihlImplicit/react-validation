	...
	var Base = function (_Component) {
	    ...
	    _createClass(Base, [{
	        ...
	        value: function onChange(event) {
	            ...
	            var isChecked = this.state.isCheckbox ? !this.state.isChecked : true;
	            var checkboxValue = isChecked ? event.target.value : '';
	            var value = this.state.isCheckbox ? checkboxValue : event.target.value;
	            ...
	            this.setState({
	                ...
	                _this3.context.validateState(_this3.props.name);

	                (_this3.props.onChange || _noop2.default)(event);
	            });
	        }
	    }, {
	        key: 'onBlur',
	        value: function onBlur(event) {
	            ...
	            this.setState({
	                ...
	                _this4.context.validateState(_this4.props.name);

	                (_this4.props.onBlur || _noop2.default)(event);
	            });
	        }
	    }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function inputFactory(WrappedComponent) {
	        ...
	        _createClass(CustomInput, [{
	            ...
	            value: function render() {
	                ...
	                var _props = this.props,
	                    ...
	                    help = _props.help,
	                    helpClassName = _props.helpClassName,
	                    rest = _objectWithoutProperties(_props, ['validations', 'errorClassName', 'containerClassName', 'errorContainerClassName', 'className', 'value', 'onChange', 'onBlur', 'help', 'helpClassName']);
	                // TODO: Refactor conditions
	                ...
	                if (isInvalid) {
	                    hint = typeof error === 'function' ? error(changedValue, this.context.components) : _rules2.default[error].hint(changedValue, this.context.components, this);
	                }
	    ...
	    CustomInput.propTypes = {
	        ...
	        helpClassName: _propTypes2.default.string
	    };
	    ...
	    var CustomSelect = function (_Base) {
	        ...
	        _createClass(CustomSelect, [{
	            ...
	            value: function render() {
	                ...
	                if (isInvalid) {
	                    hint = typeof error === 'function' ? error(this.state.value, this.context.components) : _rules2.default[error].hint(this.state.value, this.context.components, this);
	                }
	        ...
	        _this.getErrors = function () {
	            return Object.keys(_this.components).reduce(function (prev, name) {
	                ...
	                for (var i = 0; i < length; i += 1) {
	                    if (!_rules2.default[validations[i]].rule(component.state.value, _this.components, component)) {
	                        /* eslint-disable */
	                        prev[name] = prev[name] || [];
	    ...
	    _createClass(Input, [{
	        ...
	        value: function render() {
	            var _props = this.props,
	                ...
	                help = _props.help,
	                helpClassName = _props.helpClassName,
	                rest = _objectWithoutProperties(_props, ['containerClassName', 'hint', 'help', 'helpClassName']);
	            ...
	            return _react2.default.createElement(
	                ...
	                !hint && help && _react2.default.createElement(
	                    'div',
